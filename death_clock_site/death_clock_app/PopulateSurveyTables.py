...
def populateSurveyTables():
    ...
    questions = [
        ...
        [10,"Do you not use sunscreen on a regular basis?"],
        [9,"Do you spend greater than 30 hours a week in the sun?"],
        [11,"Do you tan one time a week or more?"],
        [70,"Do you live in an area that gets below 0F frequently in the winter or over 100F frequently in the summer?"],
